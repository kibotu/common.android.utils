 ...
 * the measure pass.
 */
public class LinearLayoutManagerWrappedContent extends android.support.v7.widget.LinearLayoutManager {
    ...
    public LinearLayoutManagerWrappedContent(Context context) {
        super(context);
        this.view = null;
    }

    @SuppressWarnings("UnusedDeclaration")
    public LinearLayoutManagerWrappedContent(Context context, int orientation, boolean reverseLayout) {
        super(context, orientation, reverseLayout);
        this.view = null;
    }

    @SuppressWarnings("UnusedDeclaration")
    public LinearLayoutManagerWrappedContent(RecyclerView view) {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public LinearLayoutManagerWrappedContent(RecyclerView view, int orientation, boolean reverseLayout) {
